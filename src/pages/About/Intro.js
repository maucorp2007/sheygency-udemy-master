  ...
  return (
    ...
    <div className="grid grid-cols-2 sm:grid-cols-1 items-center min-h-screen sm:bg-secondary sm:p-10">
        ...
        <div className='z-10 max-w-max flex flex-col space-y-5 sm:-mt-20'>
           <h1 className='text-8xl font-semibold text-white sm:text-5xl'>YORKCORP</h1>
           <hr />
           <h1 className='text-xl text-white'>PRODUCTOR DE EVENTOS | MARKETING | DESARROLLADOR WEB</h1>
        </div>
    </div>
    </>
  )
